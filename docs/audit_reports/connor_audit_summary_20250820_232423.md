...
- ❌ **Import forge.connor.base** (2.014s): Import failed: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **Import forge.connor.connor_system** (0.007s): Import failed: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **Import forge.connor.sra** (0.007s): Import failed: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **Import forge.connor.la** (0.007s): Import failed: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **Import forge.connor.uba** (0.007s): Import failed: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **Import forge.connor.aa** (0.007s): Import failed: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **Import forge.connor.gap** (0.007s): Import failed: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **Import forge.connor.mbr** (0.008s): Import failed: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 
...
- ❌ **AgentConfig Creation** (0.000s): Failed to create agent config: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 
...
- ❌ **System Initialization** (0.000s): Failed to initialize Connor system: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 
...
- ❌ **SRA Agent Import** (0.000s): Failed to import: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **LA Agent Import** (0.000s): Failed to import: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **UBA Agent Import** (0.000s): Failed to import: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **AA Agent Import** (0.000s): Failed to import: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **GAP Agent Import** (0.000s): Failed to import: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 

pip install python-multipart

- ❌ **MBR Agent Import** (0.000s): Failed to import: Form data requires "python-multipart" to be installed. 
You can install "python-multipart" with: 
...
- ✅ **Directory docs** (0.000s): Directory exists with 86 items
...
---
*Report generated by Connor System Auditor on 2025-08-20 23:24:23*
